<template>
  <UModal v-model:open="isOpen" title="Are you sure?" description="You are about to delete this post." :ui="{ footer: 'justify-end ', content: 'text-white dark:text-white bg-red-500 dark:bg-red-900', }">
